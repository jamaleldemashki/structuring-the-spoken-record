...
This thesis designs and implements a pipeline that takes a podcast archive and produces a structured, interconnected representation of the entities and relationships it contains, plus a navigation/exploration layer on top of the recordings. Applied to the *History of Philosophy* podcast, the pipeline:
